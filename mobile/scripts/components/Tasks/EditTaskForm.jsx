...
const EditTaskForm = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (editingTask.assignedTo && editingTask.assignedTo._id) {
        formData.append('assignedTo', JSON.stringify([editingTask.assignedTo._id]));
      }
      ...
      console.log('📤 Updating task with ID:', editingTask.id, 'Data:', {
        title: editingTask.title,
        status: editingTask.status,
        assignedTo: editingTask.assignedTo?._id
      });

      const response = await fetch(`${API_CONFIG.API_URL}/api/tasks/${editingTask.id}`, {
        method: 'PUT',
        headers: {
