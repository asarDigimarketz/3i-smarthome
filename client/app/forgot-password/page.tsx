  ...
  return (
    <div className="flex min-h-screen bg-black">
      ...
      <div className="relative hidden w-1/2 p-8 lg:block">
        <div className="h-full w-full overflow-hidden rounded-[40px] bg-gradient-to-b from-primary via-primary/80 to-black">
        ...
        <div className="w-full max-w-md rounded-[40px] p-12">
          <div className="mx-auto max-w-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="h-12 w-full bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary text-white font-medium rounded-lg shadow-lg hover:shadow-primary/20 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={loading}
              >
                {loading ? (
